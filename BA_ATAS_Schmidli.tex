...
\subsection{Airtime \& Spreadingfactor}
TODO
...
Für die Schweiz und in vielen Teilen Europas gilt die Regelung ERC/REC 70-03 \cite{regulations}. Dieses Dokument beschreibt die verwendbaren Frequenzen und die maximale Übertragungsleitung (dbm).
...
Die Erstellten Softwaremodule werden miteinander verknüpft und die Software fertiggestellt.
...
\begin{figure}[h]
	...
	{Gateway}
\end{figure}
Durch den Einsatz einer IP67 Box sind die elektronischen Komponenten gegen Staub und Wasser geschützt. Leider habe ich auch hier zu wenig Zeit in die Planung investiert. Wie sollte ich den Pi mit Strom versorgen? Ein zusätzlicher Anschluss musste gebohrt werden um das Kabel verlegen zu können. Um nur ein Kabel verlegen zu müssen, habe ich mir einen POE Splitter organisiert. Damit lässt sich die Energieversorgung wie auch die Datenübertragung über ein einzelnes CAT. 6 Ethernetkabel mit RJ-45 Steckern sicherstellen.
...
\newpage
\subsection{Spreadingfactor}
Es soll geprüft werden, wie sich der Spreadingfactor auf die Übertragung auswirkt.
Für diesen Test werden die folgenden Daten erhoben
\begin{enumerate}
...
\begin{thebibliography}{1}
	\bibitem{lorawan_classes} \url{https://www.rs-online.com/designspark/learning-lorawan-basics} 1.2.2019
