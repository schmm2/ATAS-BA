...
MQTT, LoRa, LoRaWAN, The Things Network\bigskip \\
...
\begin{itemize}
	...
	\item Durch den kleinen Energiebedarf halten Batteriebetriebene Geräte länger
	\item Die Kosten für die Installation eines LoRaWan Gateways sind gering +- 300.-
	\item Grosse Reichweite in nicht bebauten Gebiten (+-15km)
	\item Geringe Störanfälligkeit durch LoRa Chrip 
\end{itemize}
...
Es soll geprüft werden, wie sich der Spreadingfactor resp. Datenrate auf die Übertragung auswirkt.
Für diesen Test werden die folgenden Daten erhoben
\begin{enumerate}
	...
	\item RSSI
\end{enumerate}
Die Messungen werden in der Region 1 durchgeführt. Der Standort wird nicht gewechselt. Die Dinstanz zwischen Gateway und Tracker bleiben also gleich. Es werden pro Spreading Factor (7-12) 10 Messungen durchgeführt. Pro 10 Messwerte wurden jeweils der mindeste wie auch der maximale Messwert dH. Ausreißer entfernt.\\[0.3cm]
Gemäß Literatur müsste klar erkennbar werden, dass die SNR Werte und die RSSI Werte mit einem höheren SF besser werden, d.H das Signal stärker beim Gateway eintrifft.\\[0.3cm]
Die Messresultate:
\begin{figure}[H]
	\centering
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.9\textwidth]{img/testing/testing_sf_snr.png}
		\caption[Messwerte SNR  pro Spreadingfactor]
		{Messwerte SNR pro Spreadingfactor}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.9\textwidth]{img/testing/testing_sf_rssi.png}
...
%\newglossaryentry{lorawanendgeraet}{name={LoRaWan Endgerät},description={LoRaWan Endgerät. Atas-Node ist ein LoRaWan Endgerät}}
